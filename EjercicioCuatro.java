...
public class EjercicioCuatro {    //se crea primero una clase EjercicioCuatro (en mayúsculas)
    public static void main (String[] args){ //luego creamos el método main
        ...
        /*scanner sc :declara un *objeto* de nombre "sc" de la *clase* scanner 
         con el valor que entra por el teclado  mientras que new lo inicializa como nueva instancia o nuevo objeto * 
         */
